...
class Screen2_campus_map extends StatelessWidget {
  final String title;
  const Screen2_campus_map({super.key, required this.title});
  ...
  Widget build(BuildContext context) {
    final Image campus_map_jpg = Image.asset(
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    GlassCard(child: campus_map_jpg),
